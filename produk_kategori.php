...
<body>
    ...
    <script>
        ...
        //Fungsi getProductsByCategory(categoryId) dengan $(document).ready() terpisah:
        $(document).ready(function () {
            ...
            function getProductsByCategory(categoryId) {
                $.ajax({
                    url: 'admin/backend/get_product_by_category.php',
                    method: 'GET',
                    ...
                    error: function () {
                        $('#produkContainer').html('<p>Terjadi kesalahan saat memuat data produk berdasarkan kategori.</p>');
                    }
                });
            }
        });
